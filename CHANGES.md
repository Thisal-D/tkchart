...
| `set_line_visibility`  | Change the visibility of a specific line      | `line: tk.Line`<br>`state: bool`       | `None`      |
| `get_line_visibility`  | Get the visibility of a specific line         | `line: tk.Line`                        | `bool`      |
| `cget`        | Get the value of the specified parameter| `attribute_name: str \| "__all__"`       | `any`       |
...
| hide        | hide a specific line | line:  ``tk.Line``<br> state:  ``bool`` | None        |