...
- #### Introduction of New Parameters for Line Object Styling 
    ...
    - Destroy
      - Destroy Line
        - Destroy specific Line -> Only destroy line, -> 
      - Destroy Chart 
        - Destroy chart withing lines.
        - Call the destructor to destoy chart -> Will call automatically line destructors
    - Get line area method
        ``` python
        chart = tkchart.LineChart(**kwargs)
        line_1 = tkchart.Line(**kwargs)
        line_2 = tkchart.Line(**kwargs)
        
        # LineCharT
        # Get line area
        chart.get_line_area(line_1) # Get area of specific Line (line 1)
        chart.get_line_area(line_2) # Get area of specific line (line 2)

        # Get area of all lines
        chart.get_lines_area() # Get area of all line belongs to chart.

        # Line
        line_1.get_line_area() # Get area of line_1
        ```
